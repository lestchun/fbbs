...
"undefined" == typeof window.TY.ui.pop && (TY.ui.pop = function(a) {
    ...
    function g() {
        ...
        jQuery(".TY_login_window_body input[name=vwriter]", b).val() ? jQuery(".TY_login_window_body input[name=vpassword]", b).val() ? (document.charset = "UTF-8", c.submit()) : alert("请先输入密码") : alert("请先输入用户名")
    }
    var d = "http://passport.tianya.cn/login",
    m, h;
    a.extend(TY, {
...
TUI.show2DBarcode = function(a) {
    ...
    g = null,
    d = null;
    a("body").append('<div id="barcode_float"><a href="http://www.tianya.cn/mobile/" target="_blank"><p>吉首大学社团管理</p><img src="image/qr.png"><p>手机扫描进入</p></a></div>');
    d = a("#barcode_float");
...
TY_lite_url = "http://static.tianyaui.com/global/lite"; (function(a) {
    var b = "http://bbs.tianya.cn/",
    c = {
        loginStatus: 0,
        userId: "",
        userName: "",
    ...
    O = {
        ...
        createDom: function() {
            ...
            d.append(h);
            h = ['<div id="bottom_username_view" class="more-view"><div class="bottom_username_view_wrap"><div class="bottom_username_subnav clearfix"><ul><li class="li-first"><dl class="clearfix">', '<dt><a href="http://www.tianya.cn/' + c.userId + '">我的首页</a></dt>', '<dd><a href="http://www.tianya.cn/' + c.userId + '/blog" target="_blank">我的博客</a></dd>', '<dd><a href="http://www.tianya.cn/' + c.userId + '/laiba" target="_blank">我的部落</a></dd>', '<dd><a href="' + b + 'my_block.jsp" target="_blank">我的论坛</a></dd>', '</dl></li><li style="display:none"><dl class="js-biz-data clearfix"><dt>天涯推荐</dt></dl></li><li><dl id="bottom_my_app_list" class="clearfix"><dt><a href="http://apps.tianya.cn/" target="_blank">我的应用</a></dt></dl></li></ul></div></div></div>'].join("");
