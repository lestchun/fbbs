...
var __global = {
	...
	isOnline: function() {
		...
		- 1 != this._cookieTempTime && !isNaN(this.getUserId()) && 0 < this.getUserId() && !isNaN(this.getKey()) && 0 < this.getKey() && a && 32 == a.length && (this._isOnline = !0);
...
TUI.show2DBarcode = function(a) {
	...
	g = null,
	d = null;
	a("body").append('<div id="barcode_float"><a href="http://www.tianya.cn/mobile/" target="_blank"><p>天涯社区客户端</p><img src="http://static.tianyaui.com/global/lite/images/2Dbarcode.png"><p>手机扫描下载</p></a></div>');
	d = a("#barcode_float");
...
TY_lite_url = "http://static.tianyaui.com/global/lite"; (function(a) {
	...
	z = {
		...
		addLoginStatusHtml: function() {
			var d = [];
			1 == c.loginStatus ? (d = ['<li class="top-nav-menu-li"><a href="http://www.tianya.cn/' + c.userId + '" appstr="mypage"  _checklocation="1" _tystat="新版顶导航/用户名">' + c.userName + "</a></li>", 
			!h ? '<li class="top-nav-menu-li"><span id="top_nav_message" class="top-ico-bg">消息<strong></strong ></span></li>': "",
			 '<li class="top-nav-menu-li top-nav-menu-li-other"><span id="top_nav_set" class="top-ico-bg2"></span></li>'],
			  a("#top_nav #top_user_menu .top-nav-menu-list").append(d.join("")), 
			  d = [
